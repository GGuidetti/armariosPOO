...
public class EditorReservaUI extends javax.swing.JFrame {
    ...
    public EditorReservaUI() {
        ...
        listaDeReservas = ReservaControle.listarTodasReservas();
        populaTabela(listaDeReservas);
    }

    private void populaTabela(List<Reserva> lista) {
        DefaultTableModel modeloDeColunasDaTabela = (DefaultTableModel) tblReserva.getModel();
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        FormReservaUI form = new FormReservaUI();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (tblReserva.getSelectedRow() >= 0) {
            int dadosLinha = tblReserva.getSelectedRow();
            int codigo = (int) tblReserva.getModel().getValueAt(dadosLinha, 0);
            FormReservaUI form = new FormReservaUI(codigo);
            this.setVisible(false);            
            form.setLocationRelativeTo(this);
            form.setVisible(true);
            dispose();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (tblReserva.getSelectedRow() >= 0) {
            ...
            if (resposta == 0) {
                ...
                this.listaDeReservas = ReservaControle.listarTodasReservas();
               
                populaTabela(this.listaDeReservas);
